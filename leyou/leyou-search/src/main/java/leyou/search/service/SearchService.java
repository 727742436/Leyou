...
public class SearchService {
    ...
    public Goods bulidGoods(Spu spu) throws JsonProcessingException {
        ...
        //根据spu的cid3查询s所有的搜索规格参数
        List<SpecParam> params = this.specificationClient.queryParams(null, spu.getCid3(), null, true);

        //根据spuId查询spuDetail
        SpuDetail spuDetail = this.goodsClient.querySpuDeatilBySpuId(spu.getId());
        ...
        //获取spu下的所有sku并转换为json字符串
        goods.setSkus(MAPPER.writeValueAsString(skuMapList));
        //查询所有查询的规格参数{name:value}
